...
namespace APIVerve
{
    public class DomainandIPPingerAPIClient
    {
        ...
        public DomainandIPPingerAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public DomainandIPPingerAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
